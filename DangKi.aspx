<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangKi.aspx.cs" Inherits="DoAn.DangKi" %>
					...
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								...
								<a href="DangNhap.aspx" class="btn btn-white btn-outline-white">Đăng Nhập</a>
							</div>
			            </div>
						<div class="login-wrap p-4 p-lg-5">
		                    ...
		                    <div class="form-group">
		            	       <asp:Button class="form-control btn btn-primary submit px-3" ID="btn_dangki" runat="server" Text="Đăng Kí" OnClick="btn_dangki_Click" />
		                    </div>
